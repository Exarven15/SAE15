...
class test:
    def __init__(self, obsw, bds, tv, dte, nom, cpter): #création de la class 
        self.obsw = obsw
        self.bds = bds
        self.tv = tv
        self.dte = dte
...
class body800: #creation de la class
    def __init__(self, date, b3, b5, size, md, ms, f1, f2, f3, f4, f5, f6, f7, ips, ipd, f9, f10, f11, f14, f16, f17, f18, f20, f21, f23, f25, f26, f28, f29, f30, f32, pktd,cpter):
        self.date = date
        self.b3 = b3
        self.b5 = b5
        self.size = size
    ...
    def affiche(self): #fonction permettant d'afficher la class
        ...
        params =(self.cpter, self.date, self.b3, self.b5, self.size, self.md, self.ms, self.f1, self.f2, self.f3, self.f4, self.f5, self.f6, self.f7, "", "", "", "",self.ips, self.ipd, self.f9, self.f10, self.f11, self.f14, self.f16, self.f17, self.f18,  self.f20, self.f21, self.f23, self.f25, self.f26, self.f28, self.f29, self.f30, self.f32, self.pktd)
        with mysql.connector.connect(**connection_params) as db :
            with db.cursor() as c:
                c.execute(request, params)
                db.commit()
