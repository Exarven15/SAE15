...
def ouverture(fic): #fonction permetant de d'ouvrir le fichier binaire prend en entré le nom du fichier binaire 
    ...
    with open("Python/FT.json", "r") as fic:
        global FT
        FT = json.load(fic)
    return(FT)
...
if __name__ == '__main__':
    ouverture("C:/Users/basil/Documents/GitHub/SA-15/test/test2/ethernet.result_data")
    ...
    print(fct_transfert(FT6(f14, f18, f28, f29, f30), FT.get("FT_6")))
