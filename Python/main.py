...
@click.command()
@click.argument("bine", type=click.File('rb'), nargs=1)
@click.option("--rep", type=click.File('rb'), nargs=1, help="Obligatoire si --dt non spécifié sinon rend --dt inutile; Sert à spécifier le chemin d'accès du fichier de configuration")
