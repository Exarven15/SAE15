...
def main(bin, rep):
    ...
    while state == True:
        ...
        b5 = useft(coct+20, coct+24, "FT_0", 12, 16) #bytes
        ...
        if hex(read_convert(coct+40, coct+42))[2:] == "800":
            ...
            globals()["B{}".format(cpttrame)] = cl_trame.body800(dt, b3, b5, fz, tp, ms, md, f1, f2, f3, f4, f5, f6, ips, ipd, f9, f10, f11, f14, f16, f17, f18, f20, f21, f23, f25, f26, f27, f28, f29, f30, f32, f33, f34, f35)
            ...
            globals()["B{}".format(cpttrame)] = cl_trame.body806(dt, b3, b5, fz, tp, ms, md, f1, f2, f3, f4, f5, f6, msd, ipsd, mtg, iptg)
            globals()["B{}".format(cpttrame)].affiche()
            coct = coct + fz + 28
            cpttrame = cpttrame +1
...
main("../test/ethernet.result_data", "../test/Vt_DEMO_power_on.rep")
